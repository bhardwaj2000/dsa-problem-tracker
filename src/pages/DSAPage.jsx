...
export default function DSAPage() {
  ...
  return (
    <div>
      ...
      {/* Problems List - REST OF YOUR EXISTING CODE */}
          ...
          return (
            <div key={p.id} onClick={() => { setSelected(p.id === selected ? null : p.id); setTab("solution"); }}
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                ...
                <span style={{ fontWeight: 500, fontSize: 14, flex: 1, minWidth: 120, color: "var(--color-text-primary)" }}>{p.name}</span>
                ...
                <select value={st}
                  ...
                  onChange={e => { e.stopPropagation(); updateStatus(p.id, e.target.value, p.difficulty); }}
